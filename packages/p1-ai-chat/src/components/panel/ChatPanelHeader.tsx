...
import { WriteSetRow, type WriteSetRowProps } from '../scope/WriteSetRow.js';
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Tooltips stay off: PDS places them with floating-ui, which misplaces them in this rail,
            so `ariaLabel` is what names these. */}
