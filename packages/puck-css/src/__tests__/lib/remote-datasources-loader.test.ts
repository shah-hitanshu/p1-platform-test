...
import { listRemoteDatasourcesForPage } from "../../data/remote-datasources/user-remote-datasource-store";

vi.mock("../../data/remote-datasources/user-remote-datasource-store", () => ({
  listRemoteDatasourcesForPage: vi.fn(() => ({ global: [], page: [] })),
}));

import { loadRemoteDatasourceContext } from "../../data/remote-datasources/loader";
import type { RemoteDatasourceFetcher } from "../../data/remote-datasources/loader";
