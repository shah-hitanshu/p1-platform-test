  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        target_regions: { type: 'array', items: { type: 'string' }, description: 'Dot-notation path of each block you will change, e.g. ["content.0", "content.3"]. Name the blocks, never the bare "content" array — that reserves the entire page and highlights nothing for the people editing it.' },
      },
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        document_path: { type: 'string' },
        intent: { type: 'string' },
        target_regions: { type: 'array', items: { type: 'string' }, description: 'The same block paths passed to check_edit_permission.' },
      },
      required: ['site_id', 'branch_id', 'document_path', 'intent', 'target_regions'],
    },
  },
