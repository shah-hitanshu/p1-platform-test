...
export function CreateTemplateForm({ baseUrl, siteId, branchId }: CreateTemplateFormProps) {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Templates are an optional enhancement
      } finally {
  ...
  function onSubmit(e: React.FormEvent) {
    ...
    createMutation.mutate(
      ...
      {
        onSuccess: (resultPath) => { setMessageIsSuccess(true); setMessage(`Created template ${resultPath}`); },
