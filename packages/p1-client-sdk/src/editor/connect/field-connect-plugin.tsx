...
import { isCrossPageRefTemplateString } from "../../lib/cross-reference";
import type { RemoteDatasourceDefinition } from "../../lib/remote-datasources/remote-datasource-registry";
import type { RouteRow } from "../../lib/page-store";
...
export function createFieldConnectPlugin(opts: {
  ...
  return {
    ...
    overrides: {
      fieldTypes: {
        text: (props: ScalarFieldProps) => <ConnectableScalarField {...props} />,
        textarea: (props: ScalarFieldProps) => <ConnectableScalarField {...props} />,
      },
    },
  };
}
