...
export function handleWebSocket(
  ...
  incrementCounter('ccr_ws_connections_total', { action: 'open' });
  setGauge('ccr_ws_connections_active', deps.getConnectionCount());
...
export async function handleWebSocketDisconnect(
  ...
  incrementCounter('ccr_ws_connections_total', { action: 'close' });
  setGauge('ccr_ws_connections_active', deps.getConnectionCount());
