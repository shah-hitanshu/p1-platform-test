...
const SKIP_PATTERNS = new Set([
  ...
  'README.md',
  'CHANGELOG.md',
  // Guidance for agents working on the sample app inside this monorepo: package
  // boundaries, the scaffold contract, internal ticket refs. Meaningless to a
  // customer and the kind of internal detail check-npm-leaks.sh exists to catch.
  // A consumer-facing equivalent belongs in template-assets/.
  'CLAUDE.md',
