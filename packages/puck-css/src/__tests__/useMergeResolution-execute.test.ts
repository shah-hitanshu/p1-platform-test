    ...
    documentDiffs: [
      {
        documentId: 'doc-1',
        documentPath: '/home',
        sourceSnapshot: { content: [{ type: 'Text', props: { id: 'a', text: 'source-1' } }], root: {} },
        targetSnapshot: { content: [{ type: 'Text', props: { id: 'a', text: 'target-1' } }], root: {} },
        diffOperations: [],
      },
      {
        documentId: 'doc-2',
        documentPath: '/about',
        sourceSnapshot: { content: [{ type: 'Text', props: { id: 'b', text: 'source-2' } }], root: {} },
        targetSnapshot: { content: [{ type: 'Text', props: { id: 'b', text: 'target-2' } }], root: {} },
        diffOperations: [],
      },
      {
        documentId: 'doc-3',
        documentPath: '/contact',
        sourceSnapshot: { content: [{ type: 'Text', props: { id: 'c', text: 'source-3' } }], root: {} },
        targetSnapshot: { content: [{ type: 'Text', props: { id: 'c', text: 'target-3' } }], root: {} },
        diffOperations: [],
      },
      {
        documentId: 'doc-4',
        documentPath: '/blog',
        sourceSnapshot: { content: [{ type: 'Text', props: { id: 'd', text: 'source-4' } }], root: {} },
        targetSnapshot: { content: [{ type: 'Text', props: { id: 'd', text: 'target-4' } }], root: {} },
        diffOperations: [],
      },
    ],
  };
