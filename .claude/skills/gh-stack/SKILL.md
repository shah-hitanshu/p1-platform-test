...
Vendored from [github/gh-stack](https://github.com/github/gh-stack/tree/main/skills/gh-stack) at
commit [`14fc42e`](https://github.com/github/gh-stack/tree/14fc42ed9b6c376a53b2f999f138d3bd26dac546/skills/gh-stack)
(2026-08-03). To pick up upstream changes, diff that directory at its current `main` against this
one and re-copy — don't hand-edit the sections above in place — then update the pinned commit here.

This repo stacks with `gh stack`, not the separate `stackit` CLI/skill — they are unrelated tools
that happen to share vocabulary. PR title format, ticket references, and other PR conventions come
from this repo's [CLAUDE.md](../../../CLAUDE.md), same as any non-stacked PR.
