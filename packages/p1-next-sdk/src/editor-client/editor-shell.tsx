...
/**
 * The editor's outermost frame: which document the URL names, and the
 * providers and auth gate the content sits in.
 */
  ...
  return (
    <P1QueryProvider>
      <P1NextRouterProvider>
        <P1App config={runtime.config} loginFallback={runtime.signInPage}>
