/**
 * MCP API Client for Collaborative Content Repository
 *
 * HTTP client for the Worker API that interfaces with
 * the Agent Politeness workflow endpoints.
 * Adapted from examples/ccr-mcp/src/api-client.ts
...
export class McpApiClient {
   ...
   *
   * The CCR backend accepts an optional `snapshot` in the POST body alongside
  ...
  /**
   * Fetch component schemas from the CCR registry, with a 5-minute TTL cache.
   *
