# Collaborative Content Repository (CCR)
...
The Collaborative Content Repository receives pre-validated identity from Pantheon:
...
**Choice:** Implement agent politeness directly in CCR with: idle-detection gating, individual agent accounts, presence with advisory region locking, enhanced checkpoints, and region-aware conflict resolution.
