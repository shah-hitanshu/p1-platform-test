-- Move redirects out of the _registry/ namespace.
--
...
--
-- No row matches once the rename has happened, so a database that already ran
-- this conversion under the numbered migrations takes it as a no-op.
--
